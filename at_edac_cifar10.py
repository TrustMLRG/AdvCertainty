...
def get_args():
    ...
    parser.add_argument('--fname', default='./checkpoints/cifar_model_fpp', type=str)
    ...
    parser.add_argument('--stepsize', default=0.3, type=float)
    return parser.parse_args()

def main():
    args = get_args()

    fname = f'{args.fname}_{args.model}_{str(args.stepsize)}'
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_batches):
            ...
            ac_loss = args.stepsize  * advCertainty
